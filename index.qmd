...
## Step 1: <br> {.smaller} Determine AP receptor affinities
...
## Step 2: <br> {.smaller} Cluster APs by receptor affinities
...
## Step 3: <br> {.smaller} Characterize relationships <br>
...
![](img/Martens_web2022final.png){fig-align="top center"}
