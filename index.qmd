...
The correlation matrix effectively normalises for D2 pKi thereby 
[**accounting for the dosing differences between AP**]{style="color:#cc0000"}. Mention that we could avoid using the conversion to chlorpromazine equivalencies - mention the work that Andrea did here. 
