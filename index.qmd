...
## Method: <br> I. Determine AP receptor affinities
...
## Method: <br>  II. Cluster APs based on receptor affinities 
...
---
## Method: <br> III. Characterise relationships: <br> receptor profiles, categories, and clinical effects

::: {.incremental}
 
- Characterise the receptor-defined clusters in relation to their receptor affinities and clinical profiles.
- Compare the ability of these clusters to predict side effects 
- Compare this to existing methods of categorising APs. 
